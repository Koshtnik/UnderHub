...
def save_to_db():
    ...
    characters_data = [
        ...
        ("Марлет","Марлет","Молодой и позитивный королевский страж. Она ещё новичок в своём деле. Несёт службу в Заснежье. Верит что в некоторых людях есть добро. Не согласна с политикой Азгора. Была учиницей Чуджина Кетсукане в те времена, когда он был ещё жив. Любит строить головоломки")
    ]
